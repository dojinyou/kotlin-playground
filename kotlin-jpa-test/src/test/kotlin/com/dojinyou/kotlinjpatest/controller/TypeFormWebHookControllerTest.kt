...
@WebMvcTest(controllers = [TypeFormWebHookController::class])
class TypeFormWebHookControllerTest {
    ...
    fun handleTest() {
        ...
        post(content, "/typeform/webhook")
    }

    @Test
    fun handleSealedClassTest() {
        val content = """
            {
                "answers": [
        ...
        post(content, "/typeform/sealed")
    }

    private fun post(content: String, path: String) {
        mockMvc.perform(
